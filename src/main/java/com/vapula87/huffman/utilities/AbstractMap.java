...
import com.vapula87.huffman.interfaces.Map;

import java.util.Iterator;

/**
 * An abstract base class to ease the implementation of the com.vapula87.huffman.interfaces.Map interface.
 *
...
public abstract class AbstractMap<K,V> implements Map<K,V> {
  ...
  /**
   * A concrete implementation of the com.vapula87.huffman.interfaces.Entry interface to be used
   * within a com.vapula87.huffman.interfaces.Map implementation.
   */
  public static class MapEntry<K,V> implements Entry<K,V> {
    ...
    // public methods of the com.vapula87.huffman.interfaces.Entry interface
